...
// for 30 minute warning
    ...
    var minutes1 = rtClock1.getMinutes() + 90;                  //CHANGE 1: total minutes - 30
...
// for ADDITIONAL TIME 30 minute warning
    ...
    var minutes1AT = rtClock1AT.getMinutes() + 120;                  //CHANGE 1.1: (total minutes * 1.25) - 30; and rounded
...
// for 5 minute warning
    ...
    var minutes2 = rtClock2.getMinutes() + 115;              //CHANGE 2: total minutes - 5
...
// for ADDITIONAL TIME 5 minute warning
    ...
    var minutes2AT = rtClock2AT.getMinutes() + 145;              //CHANGE 2.1: (total minutes * 1.25) - 5; and rounded
...
// for END warning
    ...
    var minutes3 = rtClock3.getMinutes() + 120;               //CHANGE 3: total minutes
...
// for ADDITIONAL TIME END warning
    ...
    var minutes3AT = rtClock3AT.getMinutes() + 150;               //CHANGE 3.1: (total minutes * 1.25); and rounded
...
btn.addEventListener('click', () => {
    ...
    setTimeout(test, 5400000);                                      //CHANGE 5: 1000*(seconds-1800)
