...
// for 30 minute warning
    ...
    var minutes1 = rtClock1.getMinutes() + 30;
...
// for ADDITIONAL TIME 30 minute warning
    ...
    var minutes1AT = rtClock1AT.getMinutes() + 45;                  //CHANGE 1.1: (total minutes * 1.25) - 30; and rounded
...
// for 5 minute warning
    ...
    var minutes2 = rtClock2.getMinutes() + 55;
...
// for ADDITIONAL TIME 5 minute warning
    ...
    var minutes2AT = rtClock2AT.getMinutes() + 70;              //CHANGE 2.1: (total minutes * 1.25) - 5; and rounded
...
// for END warning
    ...
    var minutes3 = rtClock3.getMinutes() + 60;
...
// for ADDITIONAL TIME END warning
    ...
    var minutes3AT = rtClock3AT.getMinutes() + 75;               //CHANGE 3.1: (total minutes * 1.25); and rounded
...
//Java code for opening a new window when pressing button: 
