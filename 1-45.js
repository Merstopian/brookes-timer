...
// for 30 minute warning
    ...
    var minutes1 = rtClock1.getMinutes() + 75;                  //CHANGE 1: total minutes - 30
...
// for ADDITIONAL TIME 30 minute warning
    ...
    var minutes1AT = rtClock1AT.getMinutes() + 101;                  //CHANGE 1.1: (total minutes * 1.25) - 30; and rounded
...
// for 5 minute warning
    ...
    var minutes2 = rtClock2.getMinutes() + 100;              //CHANGE 2: total minutes - 5
...
// for ADDITIONAL TIME 5 minute warning
    ...
    var minutes2AT = rtClock2AT.getMinutes() + 126;              //CHANGE 2.1: (total minutes * 1.25) - 5; and rounded
...
// for END warning
    ...
    var minutes3 = rtClock3.getMinutes() + 105;               //CHANGE 3: total minutes
...
// for ADDITIONAL TIME END warning
    ...
    var minutes3AT = rtClock3AT.getMinutes() + 131;               //CHANGE 3.1: (total minutes * 1.25); and rounded
...
btn.addEventListener('click', () => {
    ...
    setTimeout(test, 4500000);                                      //CHANGE 5: 1000*(seconds-1800)
