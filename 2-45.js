...
// for 30 minute warning
    ...
    var minutes1 = rtClock1.getMinutes() + 135;                  //CHANGE 1: total minutes - 30
...
// for 5 minute warning
    ...
    var minutes2 = rtClock2.getMinutes() + 160;              //CHANGE 2: total minutes - 5
...
// for END warning
    ...
    var minutes3 = rtClock3.getMinutes() + 165;               //CHANGE 3: total minutes
...
btn.addEventListener('click', () => {
    ...
    setTimeout(test, 8100000);                                      //CHANGE 5: 1000*(seconds-1800)
