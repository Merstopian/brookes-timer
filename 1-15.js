...
// for 30 minute warning
    ...
    var minutes1 = rtClock1.getMinutes() + 45;                  //CHANGE 1: total minutes - 30
...
// for ADDITIONAL TIME 30 minute warning
    ...
    var minutes1AT = rtClock1AT.getMinutes() + 64;                  //CHANGE 1.1: (total minutes * 1.25) - 30; and rounded
...
// for 5 minute warning
    ...
    var minutes2 = rtClock2.getMinutes() + 70;              //CHANGE 2: total minutes - 5
...
// for ADDITIONAL TIME 5 minute warning
    ...
    var minutes2AT = rtClock2AT.getMinutes() + 89;              //CHANGE 2.1: (total minutes * 1.25) - 5; and rounded
...
// for END warning
    ...
    var minutes3 = rtClock3.getMinutes() + 75;               //CHANGE 3: total minutes
...
// for ADDITIONAL TIME END warning
    ...
    var minutes3AT = rtClock3AT.getMinutes() + 94;               //CHANGE 3.1: (total minutes * 1.25); and rounded
...
function savetime() {
    ...
    var newRowExtra = table.insertRow(-1);                        //Change 4.1



//insert Standard label                                          //Change 5.1 - copy section and shift all insertCell values up by 1
...
// insert Additional Time label                                       //Change 6.1 - copy all sections
    var table = document.getElementById('time-table');
...
btn.addEventListener('click', () => {
    const startingHours = 1;                                        //CHANGE 4
    ...
    setTimeout(test, 2700000);                                      //CHANGE 5: 1000*(seconds-1800)
